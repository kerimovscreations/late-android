...
class ReminderOptionRecyclerViewAdapter(private val mContext: Context,
                                        private val mData: ArrayList<ReminderOption>) : RecyclerView.Adapter<ReminderOptionRecyclerViewAdapter.ViewHolder>() {
